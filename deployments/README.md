...
| <a name="input_kong_version"></a> [kong\_version](#input\_kong\_version) | Kong Gateway version. | `string` | `"v5"` | no |
...
| <a name="input_rate_limit_per"></a> [rate\_limit\_per](#input\_rate\_limit\_per) | Rate Limit reset interval in seconds. | `number` | `1` | no |
