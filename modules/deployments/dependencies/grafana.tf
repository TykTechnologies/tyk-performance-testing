    ...
    "dashboards.json" = <<EOF
{
      ...
      "targets": [
        {
          ...
          "editorMode": "builder",
          "expr": "sum by(name) (k6_http_reqs_total{name=\"http://gateway-svc-tyk-tyk-headless.tyk.svc:443/httpbin-keyless/status/200\"})",
          "instant": false,
          "range": true,
          "refId": "A"
        }
      ],
      "title": "Total Requests - httpbin",
      "type": "timeseries"
    },
    {
      "datasource": {
      ...
      "targets": [
        {
          ...
          "editorMode": "builder",
          "expr": "sum by(name) (increase(k6_http_reqs_total{name=\"http://gateway-svc-tyk-tyk-headless.tyk.svc:443/httpbin-keyless/status/200\"}[1m]))",
          "instant": false,
          "range": true,
          "refId": "A"
        }
      ],
      "title": "Requests per Minute - httpbin",
      "type": "stat"
    },
    {
      "datasource": {
      ...
      "targets": [
        {
          ...
          "editorMode": "builder",
          "expr": "sum by(name) (k6_http_reqs_total{name=\"http://gateway-svc-tyk-tyk-headless.tyk.svc:443/timestamp/json\"})",
          "instant": false,
          "range": true,
          "refId": "A"
        }
      ],
      "title": "Total Requests - timestamp",
      "type": "timeseries"
    },
    {
      "datasource": {
      ...
      "targets": [
        {
          ...
          "editorMode": "builder",
          "expr": "sum by(name) (rate(k6_http_reqs_total{name=\"http://gateway-svc-tyk-tyk-headless.tyk.svc:443/timestamp/json\"}[1m]))",
          "instant": false,
          "range": true,
          "refId": "A"
        }
      ],
      "title": "Requests per Minute  - timestamp",
      "type": "stat"
    },
    {
      "datasource": {
      ...
      "targets": [
        {
          ...
          "editorMode": "builder",
          "expr": "avg by(name) (k6_http_req_duration_p99{name=\"http://gateway-svc-tyk-tyk-headless.tyk.svc:443/httpbin-keyless/status/200\"})",
          "instant": false,
          "range": true,
          "refId": "A"
        }
      ...
      "targets": [
        {
          ...
          "editorMode": "builder",
          "expr": "avg by(name) (k6_http_req_duration_p99{name=\"http://gateway-svc-tyk-tyk-headless.tyk.svc:443/timestamp/json\"})",
          "instant": false,
          "range": true,
          "refId": "A"
        }
  ...
  "uid": "e69fc6ae-52bd-4e08-a842-4a4f8798023b",
  "version": 1,
  "weekStart": ""
}
EOF
...
resource "helm_release" "grafana" {
  ...
  set {
    ...
    value = "http://promethus-prometheus-server.dependencies.svc"
  }
