...
import { getAuth, getAuthType, generateJWTKeys, generateHMACKeys, addTestInfoMetrics } from "/helpers/tests.js";
...
export function setup() {
  ...
  if (getAuth()) {
    ...
    } else if ("HMAC" === getAuthType()) {
      return generateHMACKeys(${var.config.auth.key_count})
    }
